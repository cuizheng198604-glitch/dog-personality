...
const DOG_CONFIG = {
  ...
  dogs: [
    ...
    // 38题，基于BigFive五维设计，主题：男性欲望与自我认知
  questions: [
    // ── Openness 开放性：面对欲望与幻想的开放程度 (8题) ──
    ...
    // ── Conscientiousness 尽责性：欲望面前的自律与克制 (8题) ──
    ...
    // ── Agreeableness 宜人性：欲望在人际关系中的处理 (7题) ──
    ...
    // ── Neuroticism 神经质性：欲望带来的焦虑与内心冲突 (8题) ──
  ...
  bf_dims:  bf_dims: ['Openness','Conscientiousness','Extraversion','Agreeableness','Neuroticism'],
